...
@override_settings(
    MFA_RULE_PER_USER='tests.tests_two_factor_auth.'
    'two_factor_rules.test_mfa_rule_superuser'
)
@override_settings(TWO_FACTOR_CODE_TIMEOUT_SECONDS=120)
class AuthTwoFactorMinimumSuperUserTestCase(APITestCase):
    def setUp(self):
        # Create a user
    ...
    def test_basic_authentication_wrong_code_superuser(self):
        """
        Test basic auth workflow
        """
        url = '/api/v1.1/auth/login/'
