...
@override_settings(
    ...
    MFA_RULE_PER_USER=(
        ...
        'two_factor_rules.test_mfa_rule_simpleuser'
    ),
    TWO_FACTOR_CODE_TIMEOUT_SECONDS=120
)
class AuthTwoFactorMinimumManagerTestCase(APITestCase):
    def setUp(self):
        # Create a user
    ...
    def test_basic_authentication_wrong_code_simpleuser(self):
        """
        Test basic auth workflow
        """
        url = '/api/v1.1/auth/login/'
